 ...
 * @author VíctorAndrés
 */
@WebServlet(name = "CrearUsuarioControl1", urlPatterns = {"/CrearUsuarioControl1"})
public class CrearUsuarioControl1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TipoUsuario usuarios =  ServicioTipoUsuario.getInstancia().getTipoUsuarioPorId(Integer.valueOf(tuser));
        
        Usuario usuario = new Usuario();
        usuario.setUsuario(user);
        usuario.setClave(clave);
        usuario.setTipo_usuario_id(usuarios);
